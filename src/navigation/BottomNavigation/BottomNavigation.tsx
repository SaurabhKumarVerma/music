...
const BottomNavigation = () => {
    ...
    return (
        <Tabs.Navigator initialRouteName={ESCREEN.HOME_SCREEN} screenOptions={{ headerShown: false, }} tabBar={CustomBottomTabs} >
            <Tabs.Screen name={ESCREEN.LOGIN_SCREEN} component={Login}/>
